        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <a href="#" class="flex items-center gap-x-4">
              ...
              <span class="self-center text-3xl font-black whitespace-nowrap dark:text-white">
                Mini.io
              </span>
            </a>
          </div>

          <div class="w-[80%] md:w-[60%] grid grid-cols-2 gap-6 md:flex md:gap-8 justify-between">
            <div>
              <h2 class="mb-6 text-lg font-bold text-gray-900 uppercase dark:text-white">
                PRODUCTS
              </h2>
              <ul class="text-gray-600 dark:text-gray-400 flex flex-col gap-y-4">
                <li>
