...
const Contact = () => {
  ...
  const handleSubmit = () =>
    alert(`Name: ${name}, email: ${email}, feedback: ${feedback}`)
      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between gap-10">
        ...
        <div className="form w-full h-full bg-white rounded-3xl p-10 basis-1/2 shadow-xl">
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="text-white bg-teal-500 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
